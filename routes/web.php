...
use App\Http\Controllers\Admin\CtaClickController as AdminCtaClickController;
...
Route::post('/cta-clicks', [CtaClickController::class, 'store'])->name('cta-clicks.store');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('blog-posts/search-slangs', [BlogPostController::class, 'searchSlangs'])->name('blog-posts.search-slangs');
        ...
        Route::get('cta-clicks', [AdminCtaClickController::class, 'index'])->name('cta-clicks.index');
