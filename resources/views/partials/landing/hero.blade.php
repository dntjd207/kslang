<section class="relative pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center justify-center min-h-[90vh]">
    ...
    <div class="absolute inset-0 overflow-hidden -z-10">
        <!-- Floating Blobs (stronger opacity) -->
        <div class="absolute -top-[30%] -left-[15%] w-[65%] h-[65%] rounded-full bg-fuchsia-500/30 blur-[100px] animate-blob-1"></div>
        <div class="absolute top-[10%] -right-[15%] w-[55%] h-[55%] rounded-full bg-cyan-500/25 blur-[100px] animate-blob-2"></div>
        <div class="absolute -bottom-[15%] left-[10%] w-[70%] h-[70%] rounded-full bg-violet-600/25 blur-[100px] animate-blob-3"></div>
        <div class="absolute top-[30%] left-[40%] w-[40%] h-[40%] rounded-full bg-indigo-500/20 blur-[80px] animate-blob-4"></div>

        <!-- Aurora Gradient Sweep -->
        <div class="absolute inset-0 bg-[linear-gradient(125deg,transparent_15%,rgba(217,70,239,0.15)_30%,rgba(139,92,246,0.12)_42%,rgba(99,102,241,0.1)_55%,rgba(6,182,212,0.15)_68%,transparent_85%)] bg-[length:250%_100%] animate-aurora"></div>

        <!-- Center Glow (behind title) -->
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] md:w-[900px] md:h-[500px] rounded-full bg-[radial-gradient(ellipse,rgba(139,92,246,0.25)_0%,rgba(217,70,239,0.1)_40%,transparent_70%)] animate-glow-pulse"></div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div class="hero-badge inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-xl mb-10">
        ...
        <!-- Main Heading -->
        <h1 class="text-5xl sm:text-7xl md:text-9xl font-extrabold tracking-tight mb-8 drop-shadow-[0_0_60px_rgba(139,92,246,0.3)]">
