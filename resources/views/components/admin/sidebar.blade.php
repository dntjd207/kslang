        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            @php
                $menus = [
                    ...
                    ['route' => 'admin.pages.edit', 'params' => ['slug' => 'privacy'], 'pattern' => 'admin.pages.*', 'label' => 'Pages', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
